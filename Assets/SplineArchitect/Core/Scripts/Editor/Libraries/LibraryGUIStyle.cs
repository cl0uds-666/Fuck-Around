...
namespace SplineArchitect.Libraries
{
    public static class LibraryGUIStyle
    {
        ...
        public static GUIStyle textSectionMinimized { get; private set; }
        ...
        public static GUIStyle backgroundSectionMinimized { get; private set; }
        ...
        internal static void Init()
        {
            ...
            backgroundSection = CreateBackgroundStyle(LibraryTexture.gScale20_100, 14);
            backgroundSectionMinimized = CreateBackgroundStyle(LibraryTexture.gScale15_100, 14);
            backgroundSubSection = CreateBackgroundStyle(LibraryTexture.gScale15_100, 0);
            backgroundToolbar = CreateBackgroundStyle(LibraryTexture.gScale50_100, 23);
            backgroundBottomMenu = CreateBackgroundStyle(LibraryTexture.gScale15_100, 18);
            backgroundItem1 = CreateBackgroundStyle(LibraryTexture.gScale10_100, WindowBase.itemHeight);
            ...
            textSection = CreateTextStyle(new Color(1, 1, 1, 1), new RectOffset(6, 4, -8, 0), new RectOffset(0, 0, 0, 0), 9);
            textSectionMinimized = CreateTextStyle(new Color(1, 1, 1, 0.5f), new RectOffset(6, 4, -8, 0), new RectOffset(0, 0, 0, 0), 9);
            textSubSection = CreateTextStyle(new Color(1, 1, 1, 1), new RectOffset(6, 4, 0, 0), new RectOffset(0, 0, 3, 1), 8, 0, 10);
