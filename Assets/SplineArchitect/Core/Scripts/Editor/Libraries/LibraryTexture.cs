...
namespace SplineArchitect.Libraries
{
    public class LibraryTexture
    {
        ...
        internal static void Init()
        {
            ...
            ////Set spline component icon
            //MonoScript script = AssetDatabase.LoadAssetAtPath<MonoScript>($"{EHandleFolder.GetMainFolderPath()}/Core/Scripts/Spline.cs");
            //EditorGUIUtility.SetIconForObject(script, iconSpline);
            //script = AssetDatabase.LoadAssetAtPath<MonoScript>($"{EHandleFolder.GetMainFolderPath()}/Core/Scripts/Spline_CachedData.cs");
            //EditorGUIUtility.SetIconForObject(script, iconSpline);
            //script = AssetDatabase.LoadAssetAtPath<MonoScript>($"{EHandleFolder.GetMainFolderPath()}/Core/Scripts/Spline_Deformation.cs");
            //EditorGUIUtility.SetIconForObject(script, iconSpline);
            //script = AssetDatabase.LoadAssetAtPath<MonoScript>($"{EHandleFolder.GetMainFolderPath()}/Core/Scripts/Spline_Event.cs");
            //EditorGUIUtility.SetIconForObject(script, iconSpline);
            //script = AssetDatabase.LoadAssetAtPath<MonoScript>($"{EHandleFolder.GetMainFolderPath()}/Core/Scripts/Spline_Lifecycle.cs");
            //EditorGUIUtility.SetIconForObject(script, iconSpline);
            //script = AssetDatabase.LoadAssetAtPath<MonoScript>($"{EHandleFolder.GetMainFolderPath()}/Core/Scripts/Spline_Editor.cs");
            //EditorGUIUtility.SetIconForObject(script, iconSpline);

            ////Set spline connector component icon
            //script = AssetDatabase.LoadAssetAtPath<MonoScript>($"{EHandleFolder.GetMainFolderPath()}/Core/Scripts/SplineConnector.cs");
            //EditorGUIUtility.SetIconForObject(script, iconSplineConnector);

            ////Set spline object component icon
            //script = AssetDatabase.LoadAssetAtPath<MonoScript>($"{EHandleFolder.GetMainFolderPath()}/Core/Scripts/SplineObject.cs");
            //EditorGUIUtility.SetIconForObject(script, iconSplineObject);
            //script = AssetDatabase.LoadAssetAtPath<MonoScript>($"{EHandleFolder.GetMainFolderPath()}/Core/Scripts/SplineObject_Editor.cs");
            //EditorGUIUtility.SetIconForObject(script, iconSplineObject);
            //script = AssetDatabase.LoadAssetAtPath<MonoScript>($"{EHandleFolder.GetMainFolderPath()}/Core/Scripts/SplineObject_Lifecycle.cs");
            //EditorGUIUtility.SetIconForObject(script, iconSplineObject);
        }
