...
namespace SplineArchitect.CustomTools
{
    public class PositionTool
    {
        ...
        public static void UpdateHoveredData(Event e, Ray mouseRay)
        {
            ...
            if ((activationType == ActivateType.ANCHOR || activationType == ActivateType.TANGENT) && e.control && e.shift)
            {
        ...
        internal static void Draw(Event e)
        {
            ...
            {
                if (activePart == ActivePart.SURFACE || (e.control && e.shift && activePart == ActivePart.NONE))
                {
